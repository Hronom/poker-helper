...
public final class CardsUtils {
    ...
    public static long countCombinationsForAvailableCards(
        ...
        cardsTemp.removeAll(excludeCards);
    ...
    public static long countOutsCardsForPreflop(
        ArrayList<Card> cards,
        ArrayList<Card> availableCards,
        ArrayList<Card> excludeCards,
        PokerHand pokerHand
    ...
    public static long countOutsCardsForTurn(
        ArrayList<Card> cards,
        ArrayList<Card> availableCards,
        ArrayList<Card> excludeCards,
        PokerHand pokerHand
    ...
    public static long countOutsCardsForRiver(
        ArrayList<Card> cards,
        ArrayList<Card> availableCards,
        ArrayList<Card> excludeCards,
        PokerHand pokerHand
    ...
    public static long countCombinationsForAvailableCards3(
        ArrayList<Card> cards,
        ArrayList<Card> availableCards,
        ArrayList<Card> excludeCards,
        PokerHand pokerHand
